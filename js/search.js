...
function search(value){
	...
	if(value == undefined){
		...
		// TODO: 根据标签和内容进行搜索,如果没有则返回404页面
		// 如果有: 按照标签,包含内容的次数进行排序
	...
	// 否则点击的是传递了参数进来的链接按钮	
		...
		if(label_html_map.get(value) == undefined || label_html_map.get(value) == null || $.trim(label_html_map.get(value)) == ''){
			$(".my-main-div").load("https://cdn.jsdelivr.net/gh/dimlt/dimlt.github.io@0.2.9/htmls/404.html",search_finished_html);
		}else{
			$(".my-main-div").load("https://cdn.jsdelivr.net/gh/dimlt/dimlt.github.io@0.2.9/htmls/"+label_html_map.get(value));
		}
